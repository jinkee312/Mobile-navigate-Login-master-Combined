...
import kotlinx.android.synthetic.main.staffregister.*
import kotlinx.android.synthetic.main.staffregister.register
...
class StaffRegister : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.staffregister)
...
//                        val uid = mAuth!!.currentUser!!.uid
                        ...
                        Toast.makeText(this@StaffRegister, "Authentication failed.",
    ...
    private fun updateUserInfoAndUI() {
        //start next activity
        val intent = Intent(this@StaffRegister, StaffLogin::class.java)
